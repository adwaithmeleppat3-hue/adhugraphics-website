...
const PORTFOLIO = [
  ...
  {
    id: 6,
    title: 'Vadakkumuri Chiramanangad Work',
    category: 'Announcements',
    date: 'Jan 2026',
    description: 'calender work done for vadakkumuri chiramanangad',
    image: '/assets/6.png',
    tall: true,
  },
  {
    id: 7,
    title: 'New Ninavu Work',
    category: 'Festival Designs',
    date: 'Jun 2026',
    description: 'media partner work done for new ninavu kattakampal',
    image: '/assets/7.png',
    tall: false,
  },
  {
    id: 8,
    title: 'Critiano Ronaldo Wallpaper',
    category: 'Social Media',
    date: 'Sep 2026',
    description: 'cristiano ronaldo wallpaper for phone',
    image: '/assets/8.png',
    tall: true,
  },
  {
    id: 9,
    title: 'Dharshna Konnanbazar work',
    category: 'Promotional Designs',
    date: 'Apr 2026',
    description: 'Work done for dharshana konnanbazar the team is aattam kalasamithi',
    image: '/assets/9.png',
    tall: false,
  },
]
